    ...
    <body class="app">
        ...
        <div class="mobile-menu md:hidden">
            ...
            <ul class="border-t border-theme-24 py-5 hidden">
                <li>
                    <a href="{{ route('admin_dashboard') }}" class="menu <?php if($pagename=="admin_dashboard")echo 'menu--active'; ?>">
                        <div class="menu__icon"> <i data-feather="home"></i> </div>
                        <div class="menu__title"> Dashboard </div>
                    </a>
                </li>
               <li>
                        <a href="{{ route('org') }}" class="menu <?php if($pagename=="org")echo 'menu--active'; ?>">
                            <div class="menu__icon"> <i data-feather="users"></i> </div>
                            <div class="menu__title"> Orgnizations </div>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('csv') }}" class="menu <?php if($pagename=="csv")echo 'menu--active'; ?>">
                            <div class="menu__icon"> <i data-feather="users"></i> </div>
                            <div class="menu__title"> Admin Panel CSV Export</div>
                        </a>
                    </li>
        ...
        <div class="flex">
            ...
            <nav class="side-nav">
                ...
                <ul>
                    <li>
                        <a href="{{ route('admin_dashboard') }}" class="side-menu <?php if($pagename=='admin_dashboard' || !isset($pagename))echo 'side-menu--active'; ?>">
                            <div class="side-menu__icon"> <i data-feather="home"></i> </div>
                            <div class="side-menu__title"> Dashboard </div>
                        </a>
                    </li>
                  <li>
                        <a href="{{route('org')}}" class="side-menu <?php if($pagename=='org')echo 'side-menu--active'; ?>">
                            <div class="side-menu__icon"> <i data-feather="users"></i> </div>
                            <div class="side-menu__title"> Orgnizations </div>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('csv') }}" class="side-menu <?php if($pagename=='csv')echo 'side-menu--active'; ?>">
                            <div class="side-menu__icon"> <i data-feather="users"></i> </div>
                            <div class="side-menu__title"> Admin Panel CSV Export </div>
                        </a>
                    </li>
                    ...
                    <div class="intro-x dropdown w-8 h-8 relative">
                        ...
                        <div class="dropdown-box mt-10 absolute w-56 top-0 right-0 z-20">
                            <div class="dropdown-box__content box bg-theme-1 dark:bg-dark-6 text-white">
                                ...
                                <div class="">
                                    <a href="{{route('admin_logout')}}" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"> <i data-feather="toggle-right" class="w-4 h-4 mr-2"></i> Logout </a>
                                </div>
                            </div>
                        </div>
                    </div>
